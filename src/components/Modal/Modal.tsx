...
const Modal = () => {
  ...
  return (
    selectedGif && (
      <div className="fixed flex w-full justify-center items-center h-full top-0 left-0 bg-black bg-opacity-70">
        <div className="flex flex-col w-full max-w-4xl bg-gray-50 dark:bg-gray-800">
          <div className="flex w-full justify-between p-6">
            <div className="w-full">
              <h3 className="text-3xl font-bold tracking-tight truncate text-gray-700 dark:text-gray-300">
                {selectedGif.title}
              </h3>
              <a
